...
## Project Structure
    ...
    ├── akucerrdas_orangtua_38148  # Django project configurations
...
1. Clone this repo and `cd akucerrdas_orangtua_38148`
...
2. Clone this repo and `cd akucerrdas_orangtua_38148`
